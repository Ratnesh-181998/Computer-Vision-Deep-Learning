...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=240&text=Computer%20Vision%20Deep%20Learning&fontSize=42&fontColor=ffffff&animation=fadeIn" />
</div>

<img src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=24,20,12,6&height=3" width="100%">


# [Computer Vision ( Deep Learning )](https://udlbook.github.io/udlbook/)

- L1 Introduction to Computer Vision (CNN)
- L2 Revisiting CNN: deal with overfitting
- L3 CNN under the hood
- L4 Introduction to Transfer Learning
- L5 Image similarity: understanding embeddings
- L6 CNN for medical diagnosis
- L7 Object localization and detection - 1
- L8 Object localization and detection - 2
- L9 Object segmentation
- L10 Siamese networks
- L11 Generative Models / GAN’s Introduction
